...
def get_cached_binary(version: str, platform: str, expected_checksum: str) -> Optional[bytes]:
    """
    ...
    try:
        ...
        if verify_checksum(binary_data, expected_checksum):
            ...
            print(f"Cached binary checksum mismatch, will re-download")
...
def install_claude(container_name: str, binary_path: str) -> None:
    ...
    run_docker_exec(container_name, f"chmod +x /usr/local/bin/claude")
    ...
    try:
        ...
        raise ValueError("Claude installation verification failed")
