...
- Mini SWE Agent: New [mini_swe_agent()](./reference/index.html.md#mini_swe_agent) agent implementation.
...
- Gemini CLI: New [gemini_cli()](./reference/index.html.md#gemini_cli) agent for Google Gemini.
...
- Codex CLI: Execute `codex` using the `user` passed to [codex_cli()](./reference/index.html.md#codex_cli).
...
- Added [cached_agent_binaries()](./reference/index.html.md#cached_agent_binaries) function to list previously downloaded and cached agent binaries.
...
- Codex CLI: New [codex_cli()](./reference/index.html.md#codex_cli) agent for OpenAI Codex.
