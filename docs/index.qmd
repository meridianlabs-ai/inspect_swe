...
The `inspect_swe` package makes software engineering agents like [Claude Code](https://docs.anthropic.com/en/docs/claude-code/overview) and [Codex CLI](https://github.com/openai/codex) available as standard Inspect agents. For example, here we use the `claude_code()` agent as the solver in an Inspect task:
