...
| `disallowed_tools` | List of tool names to disallow entirely (see [Tools Available to Claude](https://docs.anthropic.com/en/docs/claude-code/settings#tools-available-to-claude) for a list of all tools used by default). |
