...
By default, the "auto" `version` will download Claude Code 2.1.3 (from Jan 5th, 2025) and copy it to the sandbox. This version avoids a not yet fixed compaction bug with gateways.

You can override this behaviour using the `version` option:
