...
| `goals` | Enable the Codex [`/goal`](https://developers.openai.com/codex/use-cases/follow-goals) feature (`get_goal`/`set_goal` tools). Requires Codex CLI 0.128.0 or later (set `version` accordingly). |
